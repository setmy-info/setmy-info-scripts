...
sudo rpm -i setmy-info-scripts-0.50.0.noarch.rpm
```

All in single line:

```sh
./configure && make clear clean && make all package && sudo rpm -e setmy-info-scripts && sudo rpm -i setmy-info-scripts-0.50.0.noarch.rpm
```
