...
IF (WIN32)
    ...
    IF(ISCC_EXECUTABLE)
        CONFIGURE_FILE(${PROJECT_SOURCE_DIR}/setup.iss.in ${PROJECT_BINARY_DIR}/setup.iss @ONLY)
        ADD_CUSTOM_TARGET(buildInnoSetup
            COMMAND ${ISCC_EXECUTABLE} ${PROJECT_BINARY_DIR}/setup.iss
