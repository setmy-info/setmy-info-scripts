...
ADD_CUSTOM_TARGET(buildCmdScripts     cp ${MAIN_CMD_SOURCES_PATH}/bin/* ${BINARY_OUTPUT_PATH})
ADD_CUSTOM_TARGET(buildCmdLib         cp -R ${MAIN_CMD_SOURCES_PATH}/lib/* ${LIBRARY_OUTPUT_PATH})
