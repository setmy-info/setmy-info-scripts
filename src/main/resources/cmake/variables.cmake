...
SET (SMI_VAR_PATH                   ${BUILD_PATH}/var/opt/${PROVIDER})
SET (ETC_PROFILED_OUTPUT_PATH       ${ETC_OUTPUT_PATH}/profile.d)
SET (ETC_YUM_REPOS_PATH             ${ETC_OUTPUT_PATH}/yum.repos.d)
...
SET (MAIN_HTML_SOURCES_PATH         ${MAIN_SOURCES_PATH}/html)
...
SET (TEST_ELIXIR_SOURCES_PATH       ${TEST_SOURCES_PATH}/elixir)
...
SET (DEB_INSTALL_SCRIPTS_PATH       ${MAIN_SH_SOURCES_PATH}/deb)
...
ENDIF()
IF(EXISTS ${MAIN_SH_CMAKE_PATH}/variables.cmake)
    INCLUDE(${MAIN_SH_CMAKE_PATH}/variables.cmake)
ENDIF()
