...
- Java JDK is located at /opt/jdk or /opt/jdk-${JAVA_VERSION:-25.0.2} when working on Unixes
- Java JDK is located at C:\pub\jdk-${JAVA_VERSION:-25.0.2} when working on Windows machines
