...
- Maven is located at /opt/maven or /opt/apache-maven-${MAVEN_VERSION:-3.9.12} when working on Unixes
- Maven is located at C:\pub\apache-maven-${MAVEN_VERSION:-3.9.12} when working on Windows machines
