...
- Maven is located at /opt/maven or /opt/apache-maven-${MAVEN_VERSION} when working on Unixes
- Maven is located at C:\pub\apache-maven-${MAVEN_VERSION} when working on Windows machines
